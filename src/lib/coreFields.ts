...
export const CORE_FIELDS_DEFAULT: CoreFieldDef[] = [
  ...
  { key: "office_percentage_panel",   label: "Office % / fixed panel",            defaultVisibleInForm: true,  defaultVisibleInRemote: false, defaultVisibleInParseReview: false, defaultOrder: 4,  remoteSupported: false, parseReviewSupported: false },
  ...
  { key: "price",                     label: "Price ($)",                         locked: true, defaultVisibleInForm: true, defaultVisibleInRemote: true, defaultVisibleInParseReview: true, defaultOrder: 11, remoteSupported: true, parseReviewSupported: true },
