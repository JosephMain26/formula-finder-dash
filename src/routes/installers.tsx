        ...
        <div className="max-w-[1200px] mx-auto px-3 sm:px-6 py-3 sm:py-5 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 sm:gap-4 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-lg sm:text-2xl font-bold tracking-tight truncate">Installers</h1>
              <p className="hidden sm:block text-sm text-muted-foreground mt-0.5">Manage installers for doors and openers</p>
            </div>
          </div>
